...
- **Подсчет категорий** функция для подсчета количества банковских операций определенного типа
- **Реализация поиска** реализация поиска с помощью регулярных выражений
